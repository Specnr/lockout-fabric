...
public class GoalGroup {
    ...
    public static final GoalGroup TOOLS = new GoalGroup(List.of(
            OBTAIN_WOODEN_TOOLS, OBTAIN_STONE_TOOLS, OBTAIN_IRON_TOOLS,OBTAIN_GOLDEN_TOOLS, OBTAIN_DIAMOND_TOOLS, OBTAIN_COPPER_TOOLS
    ), 2);
    ...
    public static final GoalGroup ARMOR = new GoalGroup(List.of(
            WEAR_LEATHER_ARMOR, WEAR_IRON_ARMOR, WEAR_GOLDEN_ARMOR, WEAR_DIAMOND_ARMOR, WEAR_COPPER_ARMOR
    ), 1);
    ...
    public static final GoalGroup KILL_MOB = new GoalGroup(List.of(
            KILL_COLORED_SHEEP, KILL_ELDER_GUARDIAN, KILL_GHAST, KILL_SNOW_GOLEM, KILL_SNOW_GOLEM_IN_NETHER, KILL_SILVERFISH, KILL_SLIME, KILL_STRAY, KILL_WITCH, KILL_ZOMBIE_VILLAGER, KILL_ZOGLIN, KILL_BAT,
    ...
    public static final GoalGroup FORTRESS = new GoalGroup(List.of(
            ...
            PLACE_END_CRYSTAL, OBTAIN_ENDER_CHEST, USE_BREWING_STAND, OBTAIN_4_UNIQUE_HORSE_ARMOR
    ), 3);
    public static final GoalGroup BREW_POTION = new GoalGroup(List.of(
            BREW_HEALING_POTION, BREW_INVISIBILITY_POTION, BREW_LINGERING_POTION, BREW_POISON_POTION, BREW_SWIFTNESS_POTION, BREW_WATER_BREATHING_POTION, BREW_WEAKNESS_POTION
    ), 1);
    public static final GoalGroup HORSE = new GoalGroup(List.of(
            TAME_HORSE, RIDE_HORSE, OBTAIN_4_UNIQUE_HORSE_ARMOR
    ), 1);
    ...
    public static final GoalGroup ADVANCEMENT = new GoalGroup(List.of(
            ...
            GET_HIRED_HELP_ADVANCEMENT, GET_WAX_ON_ADVANCEMENT, GET_WAX_OFF_ADVANCEMENT, GET_COUNTRY_LODE_TAKE_ME_HOME_ADVANCEMENT,
            GET_STAY_HYDRATED_ADVANCEMENT, GET_HEART_TRANSPLANTER_ADVANCEMENT
    ), 4);
    ...
    public static final GoalGroup OBTAIN_ALL = new GoalGroup(List.of(
           OBTAIN_4_UNIQUE_HORSE_ARMOR, OBTAIN_ALL_MINECARTS, OBTAIN_ALL_PUMPKINS, OBTAIN_ALL_MUSHROOMS, OBTAIN_ALL_RAW_ORE_BLOCKS, OBTAIN_4_UNIQUE_SEEDS
    ), 2);
